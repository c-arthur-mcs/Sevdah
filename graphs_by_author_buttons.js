...
function Šantić_Aleksa() {
    ...
    var k = document.getElementsByClassName("Medunjanin_Amira");
    for (let i = 0; i < k.length; i++) {
        k[i].style.display = "none"
    };
    var l = document.getElementsByClassName("Vrećo_Božo");
